...
questions=["Water boils at 212 Units at which scale? \n a.Fahrenheit\n b.Celsius\n c.Rankine\n d.Kelvin",
...
answers=['d','a','b','a','a','a','a','b','a','c','d','d','d','c','b','a',]
...
def get_random_question_answer(conn):
    ...
    return random_question,random_answer,random_index    
...
while True:
    ...
    new_thread = Thread(target = clientthread,args=(conn,addr,nicknames))
    new_thread.start()